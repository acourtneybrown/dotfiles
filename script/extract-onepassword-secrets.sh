...
okta_devprodnonprod_device_token=$(op item get "Okta" --fields "gimme-aws-creds DevProdNonProd device_token")
okta_devprodprod_device_token=$(op item get "Okta" --fields "gimme-aws-creds DevProdProd device_token")
okta_devprodpublic_device_token=$(op item get "Okta" --fields "gimme-aws-creds DevProdPublic device_token")
