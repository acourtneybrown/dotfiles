...
function macos::config_Rocket() {
  ...
  local apps=(Slack Xcode Terminal iTerm2 "Sublime Text" Alfred Gnucash VirtualBuddy datagrip goland "IntelliJ IDEA" pycharm Firefox com.runningwithcrayons.Alfred)
  for app in "${apps[@]}"; do
